...
namespace Service.EducationFinancialApi.Controllers
{
	...
	public class EducationController : BaseController
	{
		...
		public async ValueTask<IActionResult> GetDashboardStateAsync() =>
			await Process(userId => _tutorialService.GetDashboardStateAsync(new FinancialSelectTaskUnitGrpcRequest {UserId = userId}), grpc => grpc.ToModel());
		...
		{
			if (EducationHelper.GetUnit(EducationTutorial.FinancialServices, request.Unit) == null)
