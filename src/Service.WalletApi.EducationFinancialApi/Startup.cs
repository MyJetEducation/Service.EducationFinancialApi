...
using Service.WalletApi.EducationFinancialApi.Modules;

namespace Service.WalletApi.EducationFinancialApi
{
    public class Startup
    {
        ...
        {
            StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/financial");
