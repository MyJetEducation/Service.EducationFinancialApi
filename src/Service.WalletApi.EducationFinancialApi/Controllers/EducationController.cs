...
using Service.WalletApi.EducationFinancialApi.Controllers.Contracts;
using Service.WalletApi.EducationFinancialApi.Mappers;
using Service.Web;

namespace Service.WalletApi.EducationFinancialApi.Controllers
{
	[Route("/api/v1/education/financial")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialFinancialService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialFinancialService> tutorialService,
